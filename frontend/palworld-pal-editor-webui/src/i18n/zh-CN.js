...
export default {
  ...
  EntryView_Greet_6:
    " > 如果你喜欢这个工具，可以考虑赞助我，以帮助我继续开发和维护这个工具。访问我的",
  EntryView_Greet_7: " > 遇到问题？加入",
  EntryView_Greet_7_1: "或访问",
  EntryView_Greet_8: " > 我的BiliBili频道：",
  EntryView_Note_1:
    "如果你是第一次使用这个工具，你需要手动输入或选择正确的存档路径，即包含 Level.sav 文件的那个文件夹的目录。",
  EntryView_Note_2:
  ...
  EntryView_Period: "。",
  EntryView_Version_Warning:
    "此版本不是由官方 CI/CD 管道构建。请谨慎使用并验证来源。",
  ...
  Editor_Skill_EL: "元素: ",
  Editor_Mastered_Skills: "学会的主动技能",
  ...
  TopBar_Btn_Invalid_Options_ADs:
    "【此消息仅会显示一次。如果您想再次查看内容，可以从主页面访问。】我不想把这个功能做成单独的付费版来赚钱，所以如果你喜欢这个工具，可以考虑赞助我，以帮助我继续开发和维护这个工具。更多信息将会在弹出的页面展示。",

  TopBar_Btn_HealAllPals_Tooltips: "治愈帕鲁的所有负面状态，回复血量，饱食度。",
  TopBar_Pal_OOB_Tooltips:
    "显示不在玩家的帕鲁容器中的帕鲁，即，观赏笼中的帕鲁，或被其他人拿走的帕鲁。",
  TopBar_Pal_Ghost_Tooltips:
    "显示不存在的帕鲁，即游戏中找不到的帕鲁，比如，你已将其出售，丢弃，宰杀。",
  TopBar_Invalid_Options_Tooltips:
    "隐藏游戏中通常不可用的一些选项和下拉菜单，使用时请注意。",
