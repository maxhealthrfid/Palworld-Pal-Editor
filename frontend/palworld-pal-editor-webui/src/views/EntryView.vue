  ...
  <div id="entryDiv">
    ...
    <div class="left">
      ...
      <p>
        ...
        <a
          target="_blank"
          href="https://github.com/KrisCris/Palworld-Pal-Editor/releases"
          >GitHub Releases</a
        >
        {{ palStore.getTranslatedText("EntryView_Greet_4_1") }}
        <a
          target="_blank"
          href="https://www.nexusmods.com/palworld/mods/995?tab=files"
          >Nexus Mods</a
        >
      ...
      <p>
        {{ palStore.getTranslatedText("EntryView_Greet_7") }}
      ...
      <p>
        {{ palStore.getTranslatedText("EntryView_Greet_8") }}
